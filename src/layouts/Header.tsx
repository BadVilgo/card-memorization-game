...
const Header = ({ newGame, handleAbout }: HeaderInterface) => {
  ...
  const menuSwitch = pageMobile
    ...
    : "navigation__links";
  const hamburgerIcon = menuMobileActive ? "las la-times" : "las la-bars";
  const flagIcon = lang === "en" ? pl : en;

  return (
    <header className="header">
      <div className="header__content">
        <div>{/*Logo do dodania*/}</div>
        <nav className="navigation">
          <ul className={menuSwitch}>
            <li onClick={() => handleNewGameButton()} className={navLink}>
              <Languages text={"newGameButton"} />
            </li>
            <li onClick={() => handleAboutButton()} className={navLink}>
              <Languages text={"aboutButton"} />
            </li>
            <li onClick={() => handleLangBtn()} className={navLink}>
        ...
        <div
          ...
          className="navigation__link  navigation__hamburger "
        >
